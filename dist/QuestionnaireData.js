...
var QuestionnaireData = /** @class */ (function () {
    ...
    **/
    ...
    QuestionnaireData.prototype.updateQuestionAnswers = function (_question, _answer) {
        ...
        _question.dependingQuestions.forEach(function (dependingQuestion) {
            ...
            dependingQuestion.criteria.forEach(function (criterium) {
                ...
                if (criterium.answer.valueCoding && criterium.answer.valueCoding.code
                    ...
                    evaluatesToTrue = _this.evaluateAnswersForDependingQuestion(_answer.code.valueCoding.code, criterium.answer.valueCoding.code, criterium.operator);
                    ...
                    evaluatesToTrue = _this.evaluateAnswersForDependingQuestion(_answer.code.valueString, criterium.answer.valueString, criterium.operator);
                }
    ...
    **/
    QuestionnaireData.prototype.evaluateAnswersForDependingQuestion = function (_answer, _criterium, _operator) {
    ...
    **/
    QuestionnaireData.prototype.restoreAnswersFromQuestionnaireResponse = function (_fhirResponse) {
        var that = this;
        function answerMatchingIQuestionItemWithFhirResponseItem(_fhirItems) {
            _fhirItems.forEach(function (answerItem) {
                var item = that.findQuestionById(answerItem.linkId, that.items);
                if (item) {
    ...
    */
    ...
    QuestionnaireData.prototype.setOptionsFromExtensions = function (_FHIRItem) {
        ...
        var fhirPathExtension = this.hasExtension(CALCULATED_EXPRESSION_EXTENSION, 'text/fhirpath', _FHIRItem);
        var returnValue = {
